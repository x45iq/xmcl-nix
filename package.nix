{
  ...
  in {
    x86_64-linux = {
      ...
      sha256 = "sha256:08ddc173ce9691709aef6eb254197dc6f39b39c954aae5d089b20e8f7c6d3fb9";
    };
    aarch64-linux = {
      url = "${base}/app-${version}-linux-arm64.asar";
      sha256 = "sha256:aa9e2c24958e2a9db4deb5067e2812915deacd66514169bd9653ae307453a3ec";
    };
  };
