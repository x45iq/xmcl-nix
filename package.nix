{
  ...
  in {
    x86_64-linux = {
      ...
      sha256 = "sha256:5f227e262aae6df91634f98adc5598e9b859d2c0072e1bea421be68e62934fb3";
    };
    aarch64-linux = {
      url = "${base}/app-${version}-linux-arm64.asar";
      sha256 = "sha256:d780580850524b506f4d2a3525f3a506b35f8adde7640c714dd0bc0ca01069bb";
    };
  };
