{
  ...
  in {
    x86_64-linux = {
      ...
      sha256 = "sha256:a07186983e91afd45e229ca3ab0073c514137979ac182142ae945be6d8d7e448";
    };
    aarch64-linux = {
      url = "${base}/app-${version}-linux-arm64.asar";
      sha256 = "sha256:8d878d6a99c05b97828788e4ae07cdd5cf70469093061eee1e2404fe51615088";
    };
  };
