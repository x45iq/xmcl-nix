{
  ...
  in {
    x86_64-linux = {
      ...
      sha256 = "sha256:915ef01eaa51d2184fa9bfa3dffb73b50cd9bc4147b90b9e5fe1c659d53e1d1b";
    };
    aarch64-linux = {
      url = "${base}/app-${version}-linux-arm64.asar";
      sha256 = "sha256:4ffe9f8bef4f7cf9b4a546695f39399ac59263781ef9921b7d9dde855e97f58c";
    };
  };
