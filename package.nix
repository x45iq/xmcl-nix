{
  ...
  in {
    x86_64-linux = {
      ...
      sha256 = "sha256:a1cd4a48320d3166700af139eeb219e51a33c6a84355e988c28379d5939433e3";
    };
    aarch64-linux = {
      url = "${base}/app-${version}-linux-arm64.asar";
      sha256 = "sha256:4b91e86f33d6a92955d266d9272605b5f93b85ffea4a03b21a85bb889a120e26";
    };
  };
